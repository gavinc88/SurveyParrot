...
public class Survey {
    ...
    private static ArrayList<Survey> makeSurveys() {
        ...
        Survey snacks = new Survey();
        snacks.name = "Snacks";
        snacks.addQuestion(new Question("How do you like your peanut butter?", Question.QUESTION_TYPE_MULTIPLE_CHOICE, 2).addAnswer(0, "A. Crunchy").addAnswer(1, "B. Creamy"));
        snacks.addQuestion(new Question("Rate from 1 to 5, with 5 being most frequent. How often do you eat snacks?", Question.QUESTION_TYPE_RATING));
        snacks.addQuestion(new Question("Yes or no: Do you like to eat chips?", Question.QUESTION_TYPE_YES_NO));
        out.add(snacks);

        Survey politics = new Survey();
        politics.name = "Politics";
        politics.addQuestion(new Question("Rate from 1 to 5, with 5 being high. How politically active are you?", Question.QUESTION_TYPE_RATING));
        ...
        politics.addQuestion(new Question("Rate from 1 to 5, with 5 being most. How satisfied are you with the current president?", Question.QUESTION_TYPE_RATING));
